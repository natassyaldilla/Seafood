                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <p>Menampilkan total harga pemesanan diatas Rp500.000 dengan view</p>
                            <div class="row justify-content-between">
                                <!-- <div class="col-4">
                                    <a href="<?=BASEURL?>/Pemesanan/create" class="btn btn-primary">Tambah Data + </a>
                                </div>
                                <div class="col-4">
                                    <a href="<?=BASEURL?>/pemesanan/control" class="btn btn-dark  float-end ms-2 ">Control</a>
                                </div> -->
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table text-nowrap">
                                   ...
                                   <tbody>
                                       <?php
                                       $no = 1;
                                       foreach($data['view_control'] as $p) :?>
                                       <tr>
                                            <td><?=$no++?></td>
